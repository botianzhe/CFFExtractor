...
gunet=buildmodel()
modelpaths='/data1/msf/triplet/bestmodel/c40best/'
...
for epoch in range(config.epochs):
    ...
    if epoch_loss < best_loss:
        best_loss = epoch_loss
        ckpt_path = os.path.join(config.save_dir, modelname+'/eff0_smp_adaptiveunet_' +str(exceptdata)+
